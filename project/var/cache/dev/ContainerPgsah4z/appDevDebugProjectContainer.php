...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\controller\\jokecontroller' => 'AppBundle\\Controller\\JokeController',
            ...
            'appbundle\\form\\joketype' => 'AppBundle\\Form\\JokeType',
            'appbundle\\form\\loginform' => 'AppBundle\\Form\\LoginForm',
            'appbundle\\form\\signupform' => 'AppBundle\\Form\\SignupForm',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Controller\\JokeController' => 'getJokeControllerService.php',
            'AppBundle\\Controller\\UserController' => 'getUserControllerService.php',
            'AppBundle\\Form\\CategoryType' => 'getCategoryTypeService.php',
            'AppBundle\\Form\\JokeType' => 'getJokeTypeService.php',
            'AppBundle\\Form\\LoginForm' => 'getLoginFormService.php',
            'AppBundle\\Form\\SignupForm' => 'getSignupFormService.php',
            ...
            'service_locator.bqoaofd' => 'getServiceLocator_BqoaofdService.php',
            'service_locator.dymdql9' => 'getServiceLocator_Dymdql9Service.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Form\\JokeType' => true,
            'AppBundle\\Form\\LoginForm' => true,
            'AppBundle\\Form\\SignupForm' => true,
            ...
            'service_locator.bqoaofd' => true,
            'service_locator.dymdql9' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('mkN28ONukZ', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W92K3IVjFA', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1shFnjQnOH', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NlLRWTryka', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tGV6w1J6d4', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getForm_RegistryService()
    {
        ...
        }, 'AppBundle\\Form\\JokeType' => function () {
            return ${($_ = isset($this->services['AppBundle\Form\JokeType']) ? $this->services['AppBundle\Form\JokeType'] : $this->services['AppBundle\Form\JokeType'] = new \AppBundle\Form\JokeType()) && false ?: '_'};
        }, 'AppBundle\\Form\\LoginForm' => function () {
            return ${($_ = isset($this->services['AppBundle\Form\LoginForm']) ? $this->services['AppBundle\Form\LoginForm'] : $this->services['AppBundle\Form\LoginForm'] = new \AppBundle\Form\LoginForm()) && false ?: '_'};
        }, 'AppBundle\\Form\\SignupForm' => function () {
            return ${($_ = isset($this->services['AppBundle\Form\SignupForm']) ? $this->services['AppBundle\Form\SignupForm'] : $this->services['AppBundle\Form\SignupForm'] = new \AppBundle\Form\SignupForm()) && false ?: '_'};
